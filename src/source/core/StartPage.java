 ...
 * @author Kartikeya
 * TODO 1) Check where the activity is being returned from in a better way and act appropriately
 * 2) Code Cleanup
 * 3) Enter button should also be an image button
 *
 */
public class StartPage extends Activity {
     ...
     */
    private void makeUI(boolean isEnter, boolean showToast)
    {
        ...
        if(showToast)
        {
        	//CHECK THIS
        	mLoginButton.logout();
        	Toast.makeText(this, "Problem connecting to server. Please try again later...", Toast.LENGTH_SHORT).show();
        }
    }
